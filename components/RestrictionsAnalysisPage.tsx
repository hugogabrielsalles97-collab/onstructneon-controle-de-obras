...
import { Restriction, RestrictionStatus, RestrictionPriority, RestrictionType, Task, User } from '../types';
...
const RestrictionsAnalysisPage: React.FC<RestrictionsAnalysisPageProps> = ({
    ...
    const handleGenerateAI = async () => {
        ...
        try {
            ...
            const genAI = new GoogleGenerativeAI(apiKey, { fetch: customFetch } as any);

          ...
          <div className="flex items-center">
            ...
            {onNavigateToHome && (
              <button
                ...
                className="mr-6 p-2 bg-white/5 border border-white/5 rounded-xl hover:bg-brand-accent/20 hover:border-brand-accent/30 hover:text-brand-accent text-brand-med-gray transition-all duration-300 flex items-center gap-2 group"
                title="Voltar para Seleção de Módulos"
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="group-hover:-translate-x-1 transition-transform">
                  <path d="M19 12H5M12 19l-7-7 7-7" />
                </svg>
                <span className="text-xs font-bold uppercase tracking-wider hidden md:inline">Voltar</span>
              </button>
            )}
